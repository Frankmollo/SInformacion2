...
public class ServicioSetUpImpl implements ServicioSetUp {
	...
	public void prepararSetup() {
		...
		if (setUp == null || !setUp.isCompletado()) {
			...
			// crear generos
			Genero rock = new Genero("JORDAN");
			entityManager.persist(rock);
			Genero indie = new Genero("TOMMY JEANS");
			entityManager.persist(indie);
			Genero pop = new Genero("ADIDAS");
			...
			for (int i = 0; i < 20; i++) {
				...
				Disco d = new Disco("GRAPHIC MUJER" + i, "Blanco", "M", "1999", rndPrecio);
				d.setAlta(true);
				d.setGenero(rock);
			...
			Disco d1 = new Disco("FANBASE GRAPHIC MUJER", "Blanco", "S", "2013", 27.99);
			d1.setGenero(indie);
			d1.setAlta(true);
			...
			Disco d2 = new Disco("FANBASE GRAPHIC MUJER", "Blanco", "M", "2020", 19.99);
			d2.setGenero(indie);
			d2.setAlta(true);
			...
			Disco d3 = new Disco("CLASSICS SLIM MUJER", "Blanco", "P", "2018", 42.5);
			d3.setGenero(rock);
			d3.setAlta(true);
			...
			Disco d4 = new Disco("CLASSICS SLIM MUJER", "Negro", "L", "1994", 13.25);
			d4.setGenero(indie);
			d4.setAlta(true);
			...
			Disco d5 = new Disco("SATOU WMNS MUJER", "Blanco", "XL", "2006", 33.33);
			d5.setGenero(rock);
			d5.setAlta(true);
			...
			Usuario u3 = new Usuario("cliente", "cliente@gmail.com", "123", "123456789", "España");
